...
/**
 * Seedance 2 文生视频请求
 * 模型端点固定使用: bytedance/seedance-2
 */
@EqualsAndHashCode(callSuper = true)
@Data
public class Seedance2Request extends SeedanceBaseRequest {

    /**
     * 生成任务的输入参数
     */
    private Seedance2Input input;

    @Data
    public static class Seedance2Input {
