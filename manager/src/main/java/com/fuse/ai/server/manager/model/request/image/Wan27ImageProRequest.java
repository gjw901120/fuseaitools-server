...
/**
 * 通义万相2.7 Pro (Wan2.7 Image Pro) 文生图/图生图请求实体类
 * 支持文本生成图像和图像编辑功能
 * 模型端点固定使用: wan/2-7-image-pro
 *
 * 特性：
 * - 支持4K超高清分辨率（仅在无图片输入且非组图生成时有效）
 * - 支持思考模式
 * - 支持自定义颜色主题
 * - 支持组图模式
 */
...
@Data
public class Wan27ImageProRequest extends WanBaseRequest {

    /**
     * 生成任务的输入参数
     */
    private Wan27ImageProInput input;
    ...
    @Data
    public static class Wan27ImageProInput {
