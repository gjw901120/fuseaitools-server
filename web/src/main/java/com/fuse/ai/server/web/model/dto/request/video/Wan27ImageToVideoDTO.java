...
/**
 * Wan 2.7 图生视频请求 DTO
 * 模型: wan-2-7-image-to-video
 */
@Data
public class Wan27ImageToVideoDTO {

    /**
     * 模型名称，固定为 wan-2-7-image-to-video
     */
    @NotBlank(message = "Model cannot be empty")
    @Pattern(regexp = "wan-2-7-image-to-video", message = "Model must be wan-2-7-image-to-video")
