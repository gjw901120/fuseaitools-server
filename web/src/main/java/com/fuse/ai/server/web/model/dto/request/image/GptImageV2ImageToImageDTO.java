...
/**
 * GPT Image 2 图生图请求 DTO
 * 模型端点固定使用: gpt-image-2-image-to-image
 */
@Data
public class GptImageV2ImageToImageDTO {

    /**
     * 模型名称，必须使用 gpt-image-2-image-to-image
     */
    @NotBlank(message = "Model cannot be empty")
    private String model = "gpt-image-2-image-to-image";
    ...
    @Size(max = 16, message = "Input URLs cannot exceed 16 items")
