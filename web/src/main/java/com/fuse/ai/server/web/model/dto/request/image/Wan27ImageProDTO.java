...
/**
 * Wan 2.7 Image Pro 图像生成/编辑请求 DTO
 * 模型: wan-2-7-image-pro
 */
@Data
public class Wan27ImageProDTO {

    /**
     * 模型名称，固定为 wan-2-7-image-pro
     */
    @NotBlank(message = "Model cannot be empty")
    @Pattern(regexp = "wan-2-7-image-pro", message = "Model must be wan-2-7-image-pro")
