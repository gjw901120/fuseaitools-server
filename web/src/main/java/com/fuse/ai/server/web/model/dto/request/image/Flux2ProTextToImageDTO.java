...
/**
 * Flux 2 Pro 文本生成图像请求 DTO
 * 模型: flux-2-pro-text-to-image
 */
@Data
public class Flux2ProTextToImageDTO {

    /**
     * 模型名称，固定为 flux-2-pro-text-to-image
     */
    @NotBlank(message = "Model cannot be empty")
    @Pattern(regexp = "flux-2-pro-text-to-image", message = "Model must be flux-2-pro-text-to-image")
