...
/**
 * Imagen 4 Generate 图像生成请求 DTO
 * 模型: imagen4-generate
 */
@Data
public class Imagen4GenerateDTO {

    /**
     * 模型名称，固定为 imagen4-generate
     */
    @NotBlank(message = "Model cannot be empty")
    @Pattern(regexp = "imagen4-generate", message = "Model must be imagen4-generate")
