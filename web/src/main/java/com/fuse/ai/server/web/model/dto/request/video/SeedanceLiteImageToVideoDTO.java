...
/**
 * Seedance Lite 图生视频请求 DTO
 */
@Data
public class SeedanceLiteImageToVideoDTO {

    /**
     * 模型名称，固定为 bytedance/v1-lite-image-to-video
     */
    @NotBlank(message = "Model cannot be empty")
    @Pattern(regexp = "seedance-v1-lite-image-to-video", message = "Model must be seedance-v1-lite-image-to-video")
     ...
     * 结束图片URL，可选
     */
    @Pattern(regexp = "^(http|https)://.*$", message = "End image URL must be a valid URL")
