...
/**
 * Flux 2 图像生成图像请求 DTO
 * 模型: flux-2-image-to-image
 */
@Data
public class Flux2ImageToImageDTO {

    /**
     * 模型名称，固定为 flux-2-image-to-image
     */
    @NotBlank(message = "Model cannot be empty")
    @Pattern(regexp = "flux-2-image-to-image", message = "Model must be flux-2-image-to-image")
